...
public class CartController {
    ...
    @Autowired
    @Lazy // This delays the initialization of cartDao until it's needed
    CartDaoImpl cartDao;
    ...
    public boolean addNewItem(@RequestParam MultipartFile file, @RequestParam("newFoodItem") String newFoodData) throws IOException {
